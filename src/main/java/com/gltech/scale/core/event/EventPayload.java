...
public class EventPayload implements Comparable<EventPayload>
{
	...
	public EventPayload(String customer, String bucket)
	{
	...
	public EventPayload(String customer, String bucket, byte[] payload)
	{
		this.uuid = UUID.randomUUID().toString();
		this.received_at = DateTime.now();
	...
	public EventPayload(String customer, String bucket, DateTime received_at, byte[] payload, String uuid, boolean stored)
	{
		this.customer = customer;
		this.bucket = bucket;
	...
	public EventPayload(String json)
	{
		try
		{
	...
	static public EventPayload jsonToEvent(JsonParser jp)
	{
		try
		{
			jp.nextToken();
			...
			return new EventPayload(customer, bucket, received_at, payload, uuid, stored);
		}
		catch (IOException e)
		{
	...
	public int compareTo(EventPayload o)
	{
