...
public class BucketMetaData
{
	...
	public BucketMetaData(String customer, String bucket, BucketType bucketType, int periodSeconds, MediaType mediaType, LifeTime lifeTime, Redundancy redundancy)
	{
	...
	public BucketMetaData(String json)
	{
		this(null, null, json);
		try
		{
	...
	public BucketMetaData(String customer, String bucket, String json)
	{
		this.customer = customer;
		this.bucket = bucket;
